    ...
    <div className="p-6 max-w-screen-xl mx-auto">
      ...
      <div className="bg-white rounded-lg border border-gray-200 mb-5">
        <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
          ...
          <a href="/tasks" className="text-xs text-indigo-600 hover:text-indigo-700 font-medium">
            View all
          </a>
        </div>
                ...
                <div key={r.id} className="flex items-start justify-between py-1.5 border-b border-gray-50 last:border-0">
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-gray-400">
                      → {r.recipientName || r.task?.owner} · <span className="font-medium text-indigo-600">{r.type}</span>
                    </p>
                  </div>
